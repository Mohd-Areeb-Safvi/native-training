...
const Animation = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <WebView
        source={{
          uri: "https://www.amazon.in/?&ext_vrnc=hi&tag=googhydrabk1-21&ref=pd_sl_19f32o2up6_e&adgrpid=64607481971&hvpone=&hvptwo=&hvadid=486382354065&hvpos=&hvnetw=g&hvrand=11171849598741491117&hvqmt=e&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=1007800&hvtargid=kwd-297775402051&hydadcr=5650_2175716&gclid=CjwKCAjwwL6aBhBlEiwADycBIK_PCWCyHgVt22izc-cny7FlbfhvEJHxIfmAz1cQdG8JQFphYiFHEBoCqsgQAvD_BwE",
        }}
      />
          ...
          transform: [
            { translateX: translateAnimation },
            {
              translateY: translateAnimation.interpolate({
                inputRange: [0, 20, 50, 80, 200],
                outputRange: [0, 10, 20, 30, 40],
              }),
            },
            // {
            //   rotate: translateAnimation.interpolate({
            //     inputRange: [0, 20, 50, 80, 200],
            //     outputRange: ["100deg", "200deg", "300deg", "400deg", "0deg"],
            //   }),
            // },
          ],
          height: 100,
